...
urlpatterns = [
    ...
    path('auth/demo-login', auth.demo_login_view, name='api_demo_login'),
    ...
    path('users/<int:user_id>/profile', users_api.get_profile, name='api_get_profile'),
    path('users/<int:user_id>', users_api.update_profile, name='api_update_profile'),
    
    # Watchlist endpoints
    path('users/<int:user_id>/watchlist', users_api.get_watchlist, name='api_get_watchlist'),
    path('users/<int:user_id>/watchlist/add', users_api.add_to_watchlist, name='api_add_watchlist'),
    path('users/<int:user_id>/watchlist/<int:tmdb_id>', users_api.remove_from_watchlist, name='api_remove_watchlist'),
    path('users/<int:user_id>/watchlist/check/<int:tmdb_id>', users_api.check_watchlist, name='api_check_watchlist'),
    
    # Favorites endpoints
    path('users/<int:user_id>/favorites', users_api.get_favorites, name='api_get_favorites'),
    path('users/<int:user_id>/favorites/add', users_api.add_to_favorites, name='api_add_favorites'),
    path('users/<int:user_id>/favorites/<int:tmdb_id>', users_api.remove_from_favorites, name='api_remove_favorites'),
    path('users/<int:user_id>/favorites/check/<int:tmdb_id>', users_api.check_favorites, name='api_check_favorites'),
    
    # Viewing history endpoints
    path('users/<int:user_id>/watched', users_api.get_viewing_history, name='api_get_history'),
    path('users/<int:user_id>/watched/add', users_api.add_to_viewing_history, name='api_add_history'),
    
    # User reviews endpoints
    path('users/<int:user_id>/reviews', users_api.get_user_reviews, name='api_get_user_reviews'),
    path('users/<int:user_id>/reviews/add', users_api.create_review, name='api_create_review'),
    path('users/<int:user_id>/reviews/<int:review_id>', users_api.delete_review, name='api_delete_review'),
    path('reviews/<int:tmdb_id>', users_api.get_reviews_for_content, name='api_get_content_reviews'),
    
    # Follow endpoints
    path('users/<int:user_id>/followers', social_api.get_followers, name='api_get_followers'),
    path('users/<int:user_id>/following', social_api.get_following, name='api_get_following'),
    path('users/<int:user_id>/follow', social_api.follow_user, name='api_follow'),
    path('users/<int:user_id>/follow/<int:target_user_id>', social_api.unfollow_user, name='api_unfollow'),
    path('users/<int:user_id>/is-following/<int:target_user_id>', social_api.is_following, name='api_is_following'),
    
    # User lists endpoints
    path('users/<int:user_id>/lists', social_api.get_user_lists, name='api_get_user_lists'),
    path('users/<int:user_id>/lists/create', social_api.create_list, name='api_create_list'),
    ...
    path('users/<int:user_id>/notifications', social_api.get_notifications, name='api_get_notifications'),
    path('users/<int:user_id>/notifications/read', social_api.mark_notifications_read, name='api_mark_read'),
    ...
    path('users/<int:user_id>/preferences', recommendations_api.get_preferences, name='api_get_preferences'),
    path('recommendations/personalized/<int:user_id>', recommendations_api.get_personalized_recommendations, name='api_personalized'),
    path('recommendations/unified', recommendations_api.unified_recommendations, name='api_unified_recommendations'),
    ...
    path('users/recommendations/for/<int:tmdb_id>/<str:media_type>', recommendations_api.get_user_recommendations_for_content, name='api_user_recs_for_content'),
    
    # Demo user endpoints (for frontend demo mode)
    path('users/demo_user/watchlist', users_api.demo_user_watchlist, name='api_demo_watchlist'),
    path('users/demo_user/watchlist/<int:tmdb_id>', users_api.demo_user_watchlist_remove, name='api_demo_watchlist_remove'),
    path('users/demo_user/favorites', users_api.demo_user_favorites, name='api_demo_favorites'),
    path('users/demo_user/favorites/<int:tmdb_id>', users_api.demo_user_favorites_remove, name='api_demo_favorites_remove'),
    path('users/demo_user/watched', users_api.demo_user_watched, name='api_demo_watched'),
    path('users/demo_user/watched/<int:tmdb_id>', users_api.demo_user_watched_remove, name='api_demo_watched_remove'),
    path('users/demo_user/ratings', users_api.demo_user_ratings, name='api_demo_ratings'),
    path('users/demo_user/profile', users_api.demo_user_profile, name='api_demo_profile'),
    path('users/demo_user', users_api.demo_user_profile, name='api_demo_user_update'),
    
    # Demo user reviews endpoint
    path('users/demo_user/reviews', users_api.demo_user_reviews, name='api_demo_reviews'),
    path('users/demo_user/reviews/<int:review_id>', users_api.demo_user_delete_review, name='api_demo_delete_review'),
    
    # Demo user community endpoints
    path('community/demo_user/stats', social_api.demo_user_stats, name='api_demo_stats'),
    path('community/users/demo_user/lists', social_api.demo_user_lists, name='api_demo_lists'),
    path('community/users/demo_user/badge-progress', social_api.demo_user_badge_progress, name='api_demo_badge_progress'),
    path('community/user-impact/demo_user', social_api.demo_user_impact, name='api_demo_impact'),
    ...
    path('reviews/<int:review_id>/awards/add', social_api.give_review_award, name='api_give_review_award'),
    path('reviews/<int:review_id>/helpful', social_api.mark_review_helpful, name='api_mark_helpful'),
    ...
    path('community/reviews/<int:review_id>/awards/add', social_api.give_review_award, name='api_community_give_award'),
    ...
    path('community/reviews/<int:review_id>/helpful', social_api.mark_review_helpful, name='api_community_helpful'),
    ...
    path('users/<int:user_id>/stats', social_api.get_activity_stats, name='api_activity_stats'),
    ...
    path('analytics/recommendations/<int:user_id>', analytics_api.get_recommendation_metrics, name='api_rec_metrics'),
    path('analytics/platform', analytics_api.get_platform_stats, name='api_platform_stats'),
    
    # ML Recommendation API endpoints
    path('recommendations/hybrid/<int:user_id>', ml_api.get_hybrid_recommendations, name='api_hybrid_recs'),
    path('recommendations/collaborative/<int:user_id>', ml_api.get_collaborative_recommendations, name='api_collab_recs'),
    path('recommendations/similar/<int:tmdb_id>', ml_api.get_similar_items, name='api_similar_items'),
    path('recommendations/users/<int:user_id>/similar', ml_api.get_user_similarity, name='api_user_similarity'),
    path('recommendations/explain/<int:user_id>/<int:tmdb_id>', ml_api.get_recommendation_explanation, name='api_rec_explain'),
    path('recommendations/semantic-search', ml_api.semantic_search, name='api_semantic_search'),
    
    # Contextual Bandits API endpoints
    path('ml/bandit/<int:user_id>/stats', ml_api.get_bandit_statistics, name='api_bandit_stats'),
    path('ml/bandit/<int:user_id>/select', ml_api.select_recommendation_arm, name='api_bandit_select'),
    ...
    path('ml/diversity/<int:user_id>/metrics', ml_api.get_diversity_metrics, name='api_diversity_metrics'),
    ...
    path('ml/recommendations/history/<int:user_id>', ml_api.get_recommendation_history, name='api_rec_history'),
    ...
    path('ml/explainability/counterfactual/<int:user_id>/<int:tmdb_id>', ml_api.get_counterfactual_explanation, name='api_counterfactual'),
    path('ml/explainability/local/<int:user_id>/<int:tmdb_id>', ml_api.get_local_explanation, name='api_local_explanation'),
    ...
    path('ml/patterns/<int:user_id>', ml_api.get_viewing_patterns, name='api_viewing_patterns'),
]
